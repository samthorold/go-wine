...
func TestVarietyDetailPage_ShowsCharacteristics(t *testing.T) {
	...
	html := render(t, VarietyDetailPage(nil, view, form))
...
func TestVarietyDetailPage_ConfirmedBadge(t *testing.T) {
	...
	html := render(t, VarietyDetailPage(nil, confirmed, VarietyCharacteristicsFormModel{VarietyID: "v1"}))
	...
	html = render(t, VarietyDetailPage(nil, def, VarietyCharacteristicsFormModel{VarietyID: "v1"}))
